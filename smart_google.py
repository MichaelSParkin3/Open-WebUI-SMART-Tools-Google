...
class Pipe:
    class Valves(BaseModel):
        try:
            ...
            AGENT_NAME: str = Field(
                default="Smart/Core (Google AI)", description="Name of the agent"
            )
            AGENT_ID: str = Field(
                default="smart-core-gai", description="ID of the agent"
            )
        except Exception as e:
            traceback.print_exc()
    ...
    async def pipe(
        ...
        try:
            ...
            # --- Define Safety Settings to prevent API from blocking responses ---
            safety_settings = {
